...
class Minion:
    def __init__(self, coord_x, coord_y, limite_x, frame_rate = 100, speed_walk = 6, gravity = 20):
        #animacion
    ...
    def do_movement(self, delta_ms):
        ...
        if self.__minion_move_time >= self.__frame_rate:
            ...
            self.__minion_move_time = 0
            self.shoot()
            if current_time - self.__current_time_animation > 320:
                self.movimiento()
