...
class Boss:
    def __init__(self, coord_x, coord_y, frame_rate = 100, speed_walk = 6, speed_run = 12, gravity = 16, jump = 32):
        ...
        self.__iddle_l = sf.get_surface_from_spritesheeet(r"assets\img\enemy\iddle\iddle.png", 6, 1, flip = True)
        self.__walk_r = sf.get_surface_from_spritesheeet(r"assets\img\enemy\walk\walk.png", 6, 1)
        self.__walk_l = sf.get_surface_from_spritesheeet(r"assets\img\enemy\walk\walk.png", 6, 1, flip = True)
